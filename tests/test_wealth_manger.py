...
class TesPrintResults(unittest.TestCase):
    def setUp(self):
        self._calculator_obj = Calculator(150000, 80000, 2019, 80000, 6666)

    def test_print_results_easy_first(self):
        pass
    
    def test_print_results_easy_second(self):
        pass
    
    def test_print_results_easy_third(self):
        pass
    
    def test_print_results_medium_first(self):
        pass

    def test_print_results_medium_second(self):
        pass

    def test_print_results_medium_third(self):
        pass

    def test_print_results_hard_first(self):
        pass

    def test_print_results_hard_second(self):
        pass

    def test_print_results_hard_third(self):
        pass
